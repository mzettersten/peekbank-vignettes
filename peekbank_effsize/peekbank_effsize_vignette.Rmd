...
#using the metafor package
#this is a little hacky, in order to get the effect size for a one-sample test against chance
effect_sizes_15_21 <- escalc(measure="SMD",m1i=mean_target,m2i=chance,sd1i=sd_target,sd2i=sd_target,n1i=subj_n,n2i=subj_n,data=filter(by_dataset_age_means,age_binned=="(9,15]"),slab=dataset_name)
...
#using the metafor package
#this is a little hacky, in order to get the effect size for a one-sample test against chance
effect_sizes_21_27 <- escalc(measure="SMD",m1i=mean_target,m2i=chance,sd1i=sd_target,sd2i=sd_target,n1i=subj_n,n2i=subj_n,data=filter(by_dataset_age_means,age_binned=="(9,15]"),slab=dataset_name)
